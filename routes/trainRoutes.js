...
router.get('/search', async (req, res, next) => {
    ...
    const timeSlots = {
        ...
        evening: " AND TIME(departure_time) BETWEEN '17:00:00' AND '20:59:59'",
        night: " AND (TIME(departure_time) BETWEEN '21:00:00' AND '23:59:59' OR TIME(departure_time) BETWEEN '00:00:00' AND '04:59:59')"
    };
...
router.get('/', async (req, res, next) => {
    try {
        // Dropdown-ku full table thevai illai, unique sources & destinations pothum
